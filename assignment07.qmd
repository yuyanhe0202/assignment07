...
data <- read.csv("restaurant_grades.csv")
...
**Quality of the model:** The model has very high precision of 98.9%, and a moderate recall of 74.0%, missing many acutal positives.
...
The model is working well (1) globally, when we applied it to the test data, we get similar RMSE like we got from the training data (2) locally, the model has the lowest RMSE in the training data
